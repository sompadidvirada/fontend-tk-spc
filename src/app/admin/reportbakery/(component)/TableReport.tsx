...
const TableReport = ({ data }: DataProps) => {
  ...
  const t = {
    ...
    sendQty: lang === "LA" ? "ຈຳນວນສົ່ງ" : "Sent Qty",
    soldQty: lang === "LA" ? "ຈຳນວນຂາຍ" : "Sold Qty",
    expQty: lang === "LA" ? "ຈຳນວນໝົດອາຍຸ" : "Expired Qty",
    lossPercent: lang === "LA" ? "% ສູນເສຍ" : "% Loss",
    noData:
      lang === "LA"
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          ...
          className="text-xs"
        >
          {t.item} <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      cell: ({ row }) => {
        const name = row.getValue("name") as string;
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          ...
          className="text-xs"
        >
          {t.cost} <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      size: 120,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          ...
          className="text-xs"
        >
          {t.sendQty} <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      size: 100,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          ...
          className="text-xs"
        >
          {t.soldQty} <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      size: 100,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          ...
          className="text-xs"
        >
          {t.expQty} <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      size: 100,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          ...
          className="text-xs"
        >
          {t.lossPercent} <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      size: 80,
      cell: ({ row }) => (
