...
const TableData = ({
  ...
  const columns: ColumnDef<BakeryDetail>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const name = row.getValue("name") as string;
        return <div className="font-medium text-[11px] pl-5">{name}</div>;
      },
    },
    {
      id: "input_action",
      ...
      cell: ({ row }) => {
        ...
        return (
          <form onSubmit={handleSave} className="flex items-center gap-2 pl-2">
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="font-medium text-xs pl-5">{formatCurrency(price)} ₭</div>
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="font-medium text-green-600 text-xs pl-2">
