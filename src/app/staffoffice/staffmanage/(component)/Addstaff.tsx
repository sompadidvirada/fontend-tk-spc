...
import { ChevronDownIcon, UserRoundPlus, X } from "lucide-react";
...
import { createStaff } from "@/app/api/client/staff";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogTrigger asChild>
        ...
        >
          <UserRoundPlus className="mr-1 h-4 w-4" /> ສ້າງໄອດີພະນັກງານ
        </Button>
      </DialogTrigger>
      ...
      <DialogContent className="sm:max-w-106 font-lao">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-3">
              <Label htmlFor="role">ຕຳແໜ່ງ</Label>
