...
import { CakeSlice, UserRoundPlus } from "lucide-react";
...
import { createBakery } from "@/app/api/client/bakery";
...
const AddBakery = ({ categoryBakery }: DataTableProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // 2. Clean values in-place (O(1) performance impact)
    ...
    const bakeryName = formData.get("name") as string;
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogTrigger asChild>
        ...
        >
          <CakeSlice className="mr-1 h-4 w-4" /> ເພີ່ມເບເກີລີ້
        </Button>
      </DialogTrigger>
      ...
      <DialogContent className="sm:max-w-106 font-lao">
        ...
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>ເພີ່ມເບເກີລີ້</DialogTitle>
            <DialogDescription className="text-[12px]">
              ເພີ່ມລາຍລະອຽດເບເກີລີ້ເຂົ້າໃນລະບົບຕິດຕາມ.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-3">
              ...
              <Input id="name" name="name" placeholder="ຊື່ເບເກີລີ້" required />
            </div>
            ...
            <div className="grid gap-3">
              <Label htmlFor="role">ລາລາຕົ້ນທຶນ</Label>
              <NumericFormat
            ...
            <div className="grid gap-3">
              <Label htmlFor="role">ລາຄາຂາຍ</Label>
              <NumericFormat
                customInput={Input} // Use Shadcn Input as the base
                thousandSeparator={true}
                valueIsNumericString={true}
