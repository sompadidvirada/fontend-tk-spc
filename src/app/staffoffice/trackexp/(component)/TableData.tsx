...
import { BakeryDetail } from "../../orderbakery/(component)/TableBakeryOrder";

interface TableDataProp {
  selectedDate: Date | undefined;
  data: BakeryDetail[];
  value: string;
  checkBakery: Bakery_Exp[];
  setCheckBakery: React.Dispatch<React.SetStateAction<Bakery_Exp[]>>;
}

type Track_Bakery_Exp = {
  bakeryId: string;
...
const TableData = ({
  ...
  const handleSave = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const dataToApi: Track_Bakery_Exp = {
