...
export const uploadFileStock = (form: UploadStock_Requisition[]) => {
...
export const getReportRequisition = (form: {startDate: string, endDate: string, branchId: number | string}) => {
  return axios.post(`${URL}/materialrequisition/getreportstockrequisition`,form, {
    withCredentials: true
  } )
}
...
export const updateStockRemain = (form: {count: number, base_count_variant: number, material_variantId: number}, id: number) => {
  return axios.put(`${URL}/materialrequisition/updatestockremain/${id}`, form, {
    withCredentials: true
  })
}

export const deleteAllStockRequisition = (form: {date: string, branchId: number}) => {
  return axios.post(`${URL}/materialrequisition/delteallstockrequisition`, form, {
    withCredentials: true
  })
}